  ...
  return (
    <div className="d-flex flex-row justify-content-between align-items-center p-2 mt-4 px-3 rounded menuItem white" style={{boxShadow: "rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px", }}>
      ...
      <div className="d-flex flex-column align-items-center product-details">
        ...
        <div className="d-flex flex-row product-desc">
          <div className="color">
            ...
            <span className="font-weight-bold">{props.restaurant_name}</span>
          </div>
        </div>
      </div>
      <div className="d-flex flex-row align-items-center qty">
        <h5 className="text-grey mt-1 mr-1 ml-1">{props.quantity}</h5>
      </div>
      <div>
      ...
      <div className="d-flex align-items-center">
          ...
          </div>):<i onClick={() => props.removeCartItem(props.id)} className="fa fa-trash mb-1 text-danger"></i>}
      </div>
      <div className="d-flex align-items-center">
